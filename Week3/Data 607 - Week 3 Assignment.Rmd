...
(e) `<(.+?)>.+?</\\1>`
    ...
    This regex matches HTML tags such as "<tr>Row 1</tr>" since it looks for angle brackets with any characters inside, characters after that, and the same angle-bracket text with a / added to the beginning (closing tag).
